...
// import 'interface/base_network_model.dart';
...
//       {required RequestType requestType, Options? options, required T parseModel, dynamic data, Map<String, dynamic>? queryParameters, void Function(int, int)? onReceiveProgress}) async {
//     options ??= Options();
//     options.method = requestType.name;
//     final body = _getBodyModel(data);
//     try {
//       final response = await request(path, data: body, options: options, queryParameters: queryParameters);
